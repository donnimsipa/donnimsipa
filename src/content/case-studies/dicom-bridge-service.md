...
*   **From Research to Production**: Successfully evolved the project from a containerized research tool ([**`docker-dcmkit`**](https://donnimsipa.my.id/docker-dcmtk-gdcm-with-donnimsipa-docker-dcmkit)) into a battle-tested production service.
...
This project started as [**`docker-dcmkit`**](https://donnimsipa.my.id/docker-dcmtk-gdcm-with-donnimsipa-docker-dcmkit), a personal research project to containerize DICOM tools. Recognizing its potential, I expanded it into a full service with:
