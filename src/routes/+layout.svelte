...
<svelte:head>
  ...
  {#if data.meta?.siteUrl}
    <link rel="canonical" href={data.meta.siteUrl} />
    <meta property="og:url" content={data.meta.siteUrl} />
  {/if}
  ...
  >
    <div class="page-container py-3 md:py-4 flex items-center justify-between">
      ...
      <div class="flex items-center gap-2">
        <a
          href="/case-studies"
          class="hidden sm:inline-flex items-center gap-1.5 text-sm font-medium px-3 py-1.5 rounded-lg text-slate-600 dark:text-slate-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-primary-50/60 dark:hover:bg-primary-900/20 transition-all duration-200 no-underline"
        >
  ...
  <footer class="mt-auto border-t border-slate-200/40 dark:border-slate-800/40">
    <div class="page-container py-6 md:py-8">
      <div class="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div
          class="text-xs text-slate-400 dark:text-slate-500 flex items-center gap-3"
        >
          <a
            href="/case-studies"
            class="inline-flex items-center gap-1 text-xs text-slate-400 dark:text-slate-500 hover:text-primary-600 dark:hover:text-primary-400 transition-colors no-underline"
          >
            <span class="i-lucide-book-open text-xs"></span>
            Case Studies
          </a>
